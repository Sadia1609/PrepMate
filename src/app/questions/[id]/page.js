...
//   const params = useParams(); // ✅ Next.js client params
//   const id = params?.id;
...
//       const res1 = await fetch(`/api/questions/${id}`);
//       const data1 = await res1.json();
//       setQ(data1);

//       // ✅ load all questions for related list
...
//             <h1 className="text-2xl md:text-3xl font-bold mt-2">{q.title}</h1>
//             <p className="text-slate-700 mt-3">{q.explanation}</p>

//             <pre className="mt-4 bg-slate-900 text-slate-100 rounded-2xl p-4 overflow-auto text-sm">
//               {q.example}
//             </pre>

//             <div className="mt-5 flex flex-wrap gap-2">
//               <Button variant="secondary" onClick={() => markStrong(q.id)}>
//                 Mark Strong ✅
//               </Button>
//               <Button variant="secondary" onClick={() => markWeak(q.id)}>
//                 Mark Weak ⚠️
//               </Button>
//             </div>

//             <p className="text-xs text-slate-500 mt-3">
//               Tip: Go to Dashboard to see your progress.
//             </p>
//           </div>
//         </div>
//       </section>

//       {/* ✅ Related Questions (20 items) */}
//       <section className="bg-white border rounded-2xl p-6">
//         <h2 className="text-lg font-bold">More from {q.category}</h2>
//         <p className="text-sm text-slate-600 mt-1">
//           Practice more questions from the same topic (up to 20).
//         </p>
